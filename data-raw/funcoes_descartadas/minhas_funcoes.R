...
#'
#'
#' @format A tabela \code{monitora_aves_masto_florestal} e uma \code{tibble} que contem 26.420 observacoes de 19 variaveis. traz os dados de aves e mamíferos de médio e grande porte obtidos por amostragem por distancia em 40 Unidades de Conservacao do Brasil entre os anos de 2014 e 2022.
#'
#'
#'
...
#' Gerar dados filtrados a partir da Unidade de Conservacao e da especie
#'
#' @description
...
#'        )
#'
#' @param dados recebe a \code{tibble} gerada pelas funcoes \code{carregar_dados_brutos()}, ou \code{gerar_dados_selecionados()}. Por configuracao, carrega a base de dados burtos de aves e medios e grandes mamiferos do Pojeto Monitora Componente Florestal
...
#' Gera uma tabela com o numero total de anos em que cada Unidade de Consevarcao foi amostrada
#'
#' @description
#' A funcao \code{contar_n_ano_uc()} gera uma tabela contendo o numero total de anos em que cada Unidade de Conservacao foi amostrada.
#'
#' @usage contar_n_ano_uc(dados = monitora_ave_masto_florestal)
#'
...
#' Additional details...
#'
#' @return Retorna um objeto do tipo \code{tibble} contendo tres colunas, nome_uc que contem os nomes completos das Unidades de Conservacao, nome_uc_abv que contem os nomes abreviados das Unidades de Conservacao e n_anos que contem o numero de anos em que cada Unidade de Conservacao foi amostrada
#' @author
#' Vitor N. T. Borges-Junior
#' Luciana A. Fusinatto
#'
